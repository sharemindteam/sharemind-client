...
export const BuyerPaymentDetail = () => {
  ...
  const { consultData } = useLocation().state;
  if (consultData !== null) {
    // const categories: string = consultData.consultCategories;
    const categoriesArray: string[] = consultData.consultCategories;
    const resultArray: string[] = categoriesArray.concat(
          ...
          <Box>
            ...
            <div className="service-info-wrapper">
              ...
              <div className="service-info-line-wrapper">
                ...
                <div className="text-wrapper">
                  <Body3 color={Grey3}>
                    상담이 시작되면 취소 및 환불이 제한됩니다. 이미 시작된
                    상담의 환불처리의 경우 신고하기를 통해 분쟁접수를 해주시기
                    바랍니다.
                  </Body3>
                </div>
              </div>
